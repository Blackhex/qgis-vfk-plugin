...
class MainApp(QDockWidget, QMainWindow, Ui_MainApp):
    ...
    def __unLoadVfkLayer(self, vfkLayerName):
        ...
        QgsProject.instance().removeMapLayer(self.__mLoadedLayers[vfkLayerName])
    ...
    def __createToolbarsAndConnect(self):
        ...
        self.pb_amendmentDb.clicked.connect(lambda: self.browseDb_clicked('amendmentDb'))
        self.pb_exportDb.clicked.connect(lambda: self.browseDb_clicked('exportDb'))
